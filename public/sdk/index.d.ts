...
declare class TerrainPlanClip {
     ...
     * @returns 裁剪面集合
     */
    static getClippingPlanes(positions: Position[], unionClippingRegions: boolean): Cesium.ClippingPlane[];
}
...
declare class BasePoly extends BasePoly {
     ...
     * @param textStyle - 样式
     */
    setLabel(text: string, textStyle: Cesium.LabelGraphics.ConstructorOptions, 位置: Position): Graphic;
}
...
declare class Graphic {
     ...
     * @param textStyle - 样式
     */
    setLabel(text: string | CallbackProperty, textStyle: Cesium.LabelGraphics.ConstructorOptions): Graphic;
    /**
     * 设置样式
 ...
 * 粒子系统
 * @param options.position - 位置
 * @param options.modelMatrix - 可选将图元(所有几何实例)从模型转换为世界坐标的4x4变换矩阵,可以替代position。
...
declare namespace LightCylinderPrimitive {
     ...
     * @property [通用参数] - Graphic通用参数
     * @property position - 位置
     * @property [length = 1000] - 长度
     * @property [topRadius = 35] - 顶部半径
     * @property [bottomRadius = 50] - 底部半径
     * @property [particleImage] - 粒子图片
     */
    type Options = {
        通用参数?: Graphic.Options;
        position: Position;
 ...
 * 发光柱
 */
declare class LightCylinderPrimitive extends BasePrimitive {
     ...
     * 构建圆柱实例
     */
    _createCylinderInstance(topPts: Cesium.Cartesian3[], bottomPts: Cesium.Cartesian3[], height: number): Cesium.GeometryInstance;
}
...
declare class RoamLine extends Graphic {
     ...
     * @returns this
     */
    on(type: GraphicEventType | RoamingEvent, callback: (...params: any[]) => any, context: any): Graphic;
    /**
     * Unsubscribe event
     * @param type - 事件类型
     * @param callback - 回调函数
     ...
     * @returns this
     */
    off(type: GraphicEventType | RoamingEvent, callback: (...params: any[]) => any, context: any): Graphic;
    /**
     * Trigger subscription event
     * @param type - 事件类型
     * @param params - 参数
...
/**
 * 矢量图形图层
图形层用于添加各种实体，本质上是一个CustomDataSource,用于将相同类或业务属性的实体放入同一集合
...
declare namespace ImageLayer {
     ...
     * 配置信息
     * @property type - 图层类型
     * @property [imageryProvider] - Cesium各个ImageryProvider或者自定义ImageryProvider
     * @property ConstructorOptions - 图层其他参数，参考Cesium各个ImageryProvider构造函数
     */
    type Options = {
        type: ImageryType;
        imageryProvider?: Cesium.ImageryProvider;
        ConstructorOptions: XXXImageryProvider.ConstructorOptions;
    };
}
...
/**
 * primitive复合图层
复合图层用于添加多种类型的数据(PointCollection、PolylineCollection、billboardCollection、LabelCollection,PrimitiveCollection,CustomDataSource)
 * @param [通用参数] - BaseLayer通用参数
 */
...
declare class Measure {
     ...
     * 创建Label
     */
    createLabel(position: Cesium.Cartesian3 | Cesium.CallbackProperty, text: string | Cesium.CallbackProperty, labelShow?: boolean | Cesium.CallbackProperty): Cesium.Entity;
    /**
     * 插值量算贴地距离
     * @returns 贴地距离
     */
...
declare class MeasureFactory {
    constructor(viewer: Viewer, options?: any, pointOptions?: Cesium.Point.options, textOptions?: Cesium.Label.options);
    /**
     * 视图
     */
    readonly viewer: any;
...
declare class Plot {
     ...
     * @param style - 样式
     */
    draw(type: GraphicType, callback: (...params: any[]) => any, style: Cesium.Graphics.ConstructorOptions): void;
    /**
     * 编辑矢量要素
     * @param graphic - 编辑要素
     * @param callback - 回调函数
...
declare class TerrainFactory {
     ...
     * 创建地形服务
     */
    static createTerrain(type: TerrainType, options: Cesium.TerrainProvider.options): TerrainProvider;
}
...
declare class Transform {
     ...
     * @returns 系统自定义坐标
     */
    static transformCartographicArrayToWGS84Array(cartographicArr: Cesium.Cartographic[]): Position[];
    /**
 ...
 * 样式转换公共部分
 */
declare class BaseStyleConvert {
    /**
     * 转换Cesium样式为Geojson
     * @param style - 样式
     * @returns 样式
     */
    static convertCesiumObjectStyleToJSON(style: any): any;
    /**
     * 转换Geojson样式为Cesium样式
     * @param style - 样式
     * @returns 样式
     */
    static convertJsonToCesiumObject(style: any): any;
}
...
declare class StyleConvert {
     ...
     * @returns 转换后的样式
     */
    static toCesiumValue(style: any): any;
    /**
     * Cesium格式转Json对象格式
     * @returns 转换后的样式
     */
...
declare class DomUtil {
     ...
     * @param className - 类名
     */
    static parseDom(domStr: string, withWrapper: HTMLElement, className: string): HTMLDivElement | NodeListOf<ChildNode>;
    /**
     * enter full screen
     * @param el - 元素
     */
...
declare class MaterialUtil {
     ...
     */
    static createMaterialProperty(type: string, options: any): MaterialProperty;
    /**
     ...
     */
    static toCesiumValue(material: any): MaterialProperty;
    /**
...
declare class Parse {
     ...
     * @param [loop = false] - 是否需要闭合
     */
    static parsePolygonCoordToArray(positions: string | String[] | any[][], loop?: boolean): any[][];
}
...
declare class PointUtil {
     ...
     * @returns 目标点坐标
     */
    static calculatePositionByDirectionAndLen(position: Position, angle: number, radius: number): Position;
    /**
     * 计算两点之间的航向角
     * @param start - A点
     * @param end - B点
     ...
     * @returns 贴地坐标
     */
    static getSurfaceTerrainPositions(scene: Cesium.Scene, positions: Position[]): Promise<Position[]>;
    /**
     * 计算 贴地(或贴模型)高度 坐标 （非精确计算，根据当前加载的地形和模型数据情况有关）
     * @param scene - 三维地图场景对象，一般用map.scene或viewer.scene
     * @param positions - 坐标
     * @param [options = {}] - 参数对象:
     * @param [options.async = true] - 是否进行异步精确计算
     * @param [options.objectsToExclude = null] - 贴模型分析时，排除的不进行贴模型计算的模型对象，可以是： primitives, entities, 或 3D Tiles features
     * @returns 贴地坐标
     */
    static getSurfacePositions(scene: Cesium.Scene, positions: Position[], options?: {
        async?: boolean;
...
declare class PolyUtil {
     ...
     * @param [options.isOnlyPoint = false] - 是否在3dtiles模型上分析（模型分析较慢，按需开启）,默认内部根据点的位置自动判断（但可能不准）
     * @returns 插值后的数据集合
     */
...
declare class Util {
     ...
     * @returns 画布
     */
    static clipRegion2Canvas(positions: Cesium.Cartesian3[], scene: Viewer.scene): Promise<HTMLCanvasElement>;
}
...
declare class ViewerOption {
     ...
     * @returns this
     */
    setOptions(options: any): ViewerOption;
}
...
declare class Viewer {
    constructor(id: any, options: Cesium.Viewer.ConstructorOptions);
    /**
     * 注册事件
     */
    _mouseEvent: any;
     ...
     * @returns 异步
     */
    flyTo(target: BaseLayer | Cesium.Object, options?: {
        duration?: number;
     ...
     * @returns this
     */
    flyToPosition(position: string | any[] | Position, completeCallback: (...params: any[]) => any, duration: number): Viewer;
    /**
     ...
     * @returns this
     */
    zoomToPosition(position: string | any[] | Position, completeCallback: (...params: any[]) => any): Viewer;
    /**
     * 绑定指定类型事件监听器
     * @param type - 事件类型
